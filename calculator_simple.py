...
pencere.geometry("196x250")

# Entry widget'ı grid ile yerleştiriyoruz.
# columnspan=4 yaparak 4 butonluk genişliğe yayıyoruz.
...
# Butonları grid ile yerleştiriyoruz
# Entry row 0'da olduğu için butonlar row 1'den başlıyor
